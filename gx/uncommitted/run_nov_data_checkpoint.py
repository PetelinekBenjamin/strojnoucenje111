...
Usage:
- Run this file: `python great_expectations/uncommitted/run_nov_data_checkpoint.py`.
...
data_context: FileDataContext = get_context(
    context_root_dir="C:\Users\benja\Desktop\Strojno ucenje\strojnoucenje111-master\strojnoucenje111-master\gx"
)
