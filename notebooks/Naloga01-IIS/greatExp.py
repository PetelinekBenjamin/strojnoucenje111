...
Usage:
- Run this file: `python great_expectations/uncommitted/run_new_check.py`.
...
data_context: FileDataContext = get_context(
    context_root_dir=r"C:\Users\benja\Desktop\Strojnoucenje\strojnoucenje111-master\gx"
)

result: CheckpointResult = data_context.run_checkpoint(
    checkpoint_name="new_check",
    batch_request=None,
    run_name=None,
)
